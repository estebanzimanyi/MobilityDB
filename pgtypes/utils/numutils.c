 ...
 */
int16
pg_strtoint16_safe(const char *s, Node *escontext UNUSED)
{
  const char *ptr = s;
...
int32
pg_strtoint32_safe(const char *s, Node *escontext UNUSED)
{
  const char *ptr = s;
  const char *firstdigit;
  uint32    tmp = 0;
 ...
 */
int64
pg_strtoint64_safe(const char *s, Node *escontext UNUSED)
{
  const char *ptr = s;
  const char *firstdigit;
  uint64    tmp = 0;
