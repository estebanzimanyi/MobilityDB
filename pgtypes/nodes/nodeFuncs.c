...
bool
expression_tree_walker_impl(Node *node, tree_walker_callback walker,
  void *context)
{
  ListCell *temp;
 ...
 */
bool
query_tree_walker_impl(Query *query, tree_walker_callback walker,
 ...
 */
bool
range_table_walker_impl(List *rtable, tree_walker_callback walker,
  void *context, int flags)
{
  ListCell *rt;
  foreach(rt, rtable)
 ...
 */
bool
range_table_entry_walker_impl(RangeTblEntry *rte, tree_walker_callback walker,
  void *context, int flags)
{
  /*
...
Node *
expression_tree_mutator_impl(Node *node, tree_mutator_callback mutator,
  void *context)
{
  /*
    ...
    case T_List:
      {
        ...
        foreach(temp, (List *) node)
        {
          resultlist = lappend(resultlist, mutator((Node *) lfirst(temp),
            context));
        }
 ...
 */
Query *
query_tree_mutator_impl(Query *query, tree_mutator_callback mutator,
  void *context, int flags)
{
  Assert(query != NULL && IsA(query, Query));
 ...
 */
List *
range_table_mutator_impl(List *rtable, tree_mutator_callback mutator,
  void *context, int flags)
{
  List *newrt = NIL;
  ListCell *rt;
 ...
 */
bool
query_or_expression_tree_walker_impl(Node *node, tree_walker_callback walker,
  void *context, int flags)
{
...
query_or_expression_tree_mutator_impl(Node *node,
  tree_mutator_callback mutator, void *context, int flags)
{
  if (node && IsA(node, Query))
    return (Node *) query_tree_mutator((Query *) node, mutator, context,
      flags);
  else
 ...
 */
bool
raw_expression_tree_walker_impl(Node *node, tree_walker_callback walker,
  void *context)
{
  ListCell *temp;
 ...
 */
static bool
planstate_walk_subplans(List *plans, planstate_tree_walker_callback walker,
  void *context)
{
  ListCell *lc;
  foreach(lc, plans)
